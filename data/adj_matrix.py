...
if __name__ == '__main__':
    file_path = 'traindata.fasta'
    coordinate_dict = np.load('train_coordinate_dict.npy',allow_pickle=True).item()
    for index, record in tqdm(enumerate(SeqIO.parse(file_path, 'fasta'))):
        c_coords = coordinate_dict[str(record.id)]
